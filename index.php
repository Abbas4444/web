			...
			<div class="page-header" id="aboutauthor">
  			...
  			<div class="row">
  				<div class="col-sm-4">
  					<div class="panel panel-default text-center">
  						<div class="panel-body">
  							<img src="b1.jpg" alt="Text of the image">  							
							<h4>British Museum</h4>
  							<p>The British Museum is a museum dedicated to human history, art, and culture,located in the Bloomsbury area of London.Its permanent collection,numbering some 8 million works is among the largest and most comprehensive in existence and originates from all continents</p>
  						</div>
  					</div>
  				</div>
  				...
  				<div class="col-sm-4">
  					<div class="panel panel-default text-center">
  						<div class="panel-body">
  							<img src="b2.jpg" alt="Text of the image"> 
  							<h4>Big Ben</h4>
  							<p>Big Ben is the nickname for the Great Bell of the clock at the north end of the Palace of Westminster in London,and often extended to refer to the clock and the clock tower.The tower is officially known as Elizabeth Tower,renamed to celebrate the Diamond Jubilee of Elizabeth II in 2012,previously it was known simply as the Clock Tower</p>
  						</div>
  					</div>
  				</div>
  				...
  				<div class="col-sm-4">
  					<div class="panel panel-default text-center">
  						<div class="panel-body">
							<img src="b4.jpg" alt="Text of the image"> 
  							<h4>Natural History Museum</h4>
  							<p>The Natural History Museum in London is a museum of natural history that exhibits a vast range of specimens from various segments of natural history.It is one of three major museums on Exhibition Road in South Kensington,the others being the Science Museum</p>
  						</div>
  					</div>
  				</div>
  			</div><!-- end row -->
